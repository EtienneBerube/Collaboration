...
CorporateCustomer::CorporateCustomer(int _id, string _name, string _address, string _telephoneNumber,int _maxDays,
                                     string _companyName, string _companyPhoneNumber): Customer(_id, _name, _address, _telephoneNumber, Customer::CORPORATE, _maxDays),
                                                                                       companyName(_companyName), companyAddress(_companyPhoneNumber) {
